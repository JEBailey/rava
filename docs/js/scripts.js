rava.bind ("section.hero", {
    callbacks : {
        ":scope #nav li" : {
            // by using the selector in the callbacks we are having an event
            // triggered when a new element is added and the
            // scope of this event is the original element. In our case
            // '.section.hero'
